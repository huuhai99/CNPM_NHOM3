                        ...
                        <div class="form-group">
                            <label for="currentPassword">Mật khẩu hiện tại:
                                <input type="password" class="form-control pwd" id="currentPassword"
                                       placeholder="Mật khẩu hiện tại" name="user_currentPassword">
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="newPassword">Mật khẩu mới:
                                <input type="password" class="form-control pwd" id="newPassword"
                                       placeholder="Mật khẩu mới" name="user_newPassword">
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="newPassword">Nhập lại mật khẩu mới:
                                <input type="password" class="form-control pwd" id="confirmPassword"
                                       placeholder="Nhập lại mật khẩu mới" name="user_confirmPassword">
                            </label>
                        </div>
                        <input type="submit" class="btn btn-success w-100" value="Đổi mật khẩu">
                    </div>
                </form>
            </div>
        </div>
