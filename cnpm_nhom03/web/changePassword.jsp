...
<html lang="en">
<head>
    <title>Thay đổi mật khẩu - Coffee Blend</title>
    <meta charset="utf-8">
...
<%
    ...
    String explain = "";
    if (request.getAttribute("explain") != null) {
        explain = (String) request.getAttribute("explain");
    }

    String currentPW_input = "";
    String newPW_input = "";
    String confirmPW_input = "";
    if (request.getAttribute("currentPW_input") != null) {
        currentPW_input = (String) request.getAttribute("currentPW_input");
    }
    if (request.getAttribute("newPW_input") != null) {
        newPW_input = (String) request.getAttribute("newPW_input");
    }
    if (request.getAttribute("confirmPW_input") != null) {
        confirmPW_input = (String) request.getAttribute("confirmPW_input");
    }
%>
<body>
<!--Header-->
...
<!--Content-->
<div id="myModal-changePW" style="margin-top: 120px">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--form-->
                <form action="<%=UtilsPath.getPath("UpdatePassword")%>" method="post">
                    <!--container-->
                    <div class="container">
                        <p style="color: red; margin-bottom: 0"><%= error %>
                        <p style="color: red; margin-bottom: 0"><%= explain %>
                        ...
                        <div class="form-group">
                            <label for="currentPassword">Mật khẩu hiện tại:
                                <input type="password" class="form-control pwd" id="currentPassword"
                                       name="user_currentPassword" value="<%=currentPW_input%>">
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="newPassword">Mật khẩu mới:
                                <input type="password" class="form-control pwd" id="newPassword"
                                       name="user_newPassword" value="<%=newPW_input%>">
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="newPassword">Xác nhận mật khẩu mới:
                                <input type="password" class="form-control pwd" id="confirmPassword"
                                       name="user_confirmPassword" value="<%=confirmPW_input%>">
                            </label>
                        </div>
                        <div class="form-group">
                            <div class="btn-left"><input type="submit" class="btn btn-success w-auto"
                                                          value="Đổi mật khẩu"></div>
                            <div class="btn-right"><a href="infoUser.jsp" class="btn btn-success w-auto">Quay lại</a></div>
                        </div>
                    </div>
                </form>
            </div>
