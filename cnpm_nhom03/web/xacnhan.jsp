...
<html lang="en">
<head>
    <title>Mã xác nhận - Coffee Blend</title>
    <meta charset="utf-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="height: 320px">
            ...
            <div class="modal-header">
                <h3 class="modal-title">MÃ XÁC NHẬN</h3>
            </div>

            <!-- Body -->
            <div class="modal-body">
                <form action="<%=UtilsPath.getPath("ktMail")%>" method="POST">
                    <div class="container">
                        <div class="form-group">
                            <label for="phone" >Mã xác nhận:
                                <%-- 6.2 Người dùng nhập mã nhận được ở mail để xác nhận --%>
                                <p style="color: red"></p>
                            </label>
                            <input type="tel" name="maxacnhan" class="form-control" id="phone" maxlength="11" >
                        </div>

                        <button type="submit" class="btn btn-success w-100"><i class="icon-user-plus"></i> Xác nhận
                        </button>
                    </div>
                </form>
            </div>
