...
<div id="myModal-signIn" style="margin-top: 120px" class="col-md-12 pr-md-8">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <button  class="btn btn-success w-100" style="margin-top: 20px" > <a href="https://www.facebook.com/dialog/oauth?client_id=2720474321608029&redirect_uri=http://localhost:8080/cnpm_nhom03/login_facebook" style="color:white;">Đăng nhập bằng Facebook</a></button>
    ...
    &client_id=508591481116-tna9n07ahv5il3j14gnguvk01m3bd55g.apps.googleusercontent.com&approval_prompt=force"  style="color:white;">Đăng nhập bằng Google</a>
                </button>
